  ...
  ({ className, label, description, error, variant = "default", ...props }, ref) => {
    return (
      <div className={cn("flex flex-col gap-1",className)}>
        ...
        <textarea
          className={cn(
            "flex min-h-[80px] w-full rounded-md px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-2 focus-visible:border-foreground-actionable disabled:cursor-not-allowed disabled:bg-surface-muted",

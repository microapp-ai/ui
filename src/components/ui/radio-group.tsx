  ...
  return (
    <div className="flex items-center space-x-2">
      <RadioGroupPrimitive.Item
        ref={ref}
        className={cn(
          "aspect-square h-4 w-4 rounded-full border border-foreground-muted text-primary focus:outline focus:outline-1 focus: outline-offset-1 focus:outline-foreground-focusRing   disabled:cursor-not-allowed disabled:opacity-50 hover:bg-muted",
      ...
      >
        <RadioGroupPrimitive.Indicator className="flex items-center justify-center">
          <Circle className="h-2 w-2 bg-foreground rounded-[50%] text-current" />
